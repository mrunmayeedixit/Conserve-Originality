...
if(outputArray.length>0){
	...
	if (req.body.UserPrefrence == "Electrical") {
		var outputArray=[];

	fs.readFile('Electrical.txt', 'utf-8', (err, data) => { 
    if (err) throw err; 
...
if(outputArray.length>0){
	...
	if (req.body.UserPrefrence == "Biomedical") {
		var outputArray=[];

	fs.readFile('biomedical.txt', 'utf-8', (err, data) => { 
    if (err) throw err; 
...
// Creating Process id  Run to Create Process Id
  const options={
    ...
    headers: {
      ContentType : 'application/json',
      Authorization: "Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..WpgltjZi7I0lYv6FDXlpi6v5TAt-ZqSywhJAQi4njhvPtDXLyn9HLRJs7LypKZ-DJiijTpGuMBoPfCTiq_lSdEN59RcdBOjjVeJ3AkcUOH1ylq7l56IdWyDb1aaFG6C6mliiYZwmJBH3z-8t2RRjDdPvLRVqcxl_N0iQlULNm0N6SSv7pFcpghTef1oq6nK8zoHPJ4HfkYhN_5mubPHP5JVW9plqxmEG0uHo1jA-pawyObFJLTtsmPjQsYxZxbuLVR1IIbEVLruCnfe6EHuHeXQj0Wxzsi8rKpC-gEQZfn6EgxCXv9Hl9qK4zsxPPPf0Ta_pDoazlHzTOeDHgJ_nsg",
    },
    json: true,
    body:UserCheckText,
  };
